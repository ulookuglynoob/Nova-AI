...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new ai.picovoice.flutter.rhino.RhinoPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin rhino_flutter, ai.picovoice.flutter.rhino.RhinoPlugin", e);
    }
    try {
